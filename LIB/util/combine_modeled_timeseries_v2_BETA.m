...
function [ MAP_ALL_DATA ] = combine_modeled_timeseries_v2_BETA(MAP_ALL_DATA)

% pull out first cell to copy metadata from for transects:
try
   DATA_TMP = MAP_ALL_DATA(char('R046C116_OLy'));
catch
   fprintf('... Combine_modeled_timeseries_v0 - could not get metadata for flowlines. Skipping these calculations.\n');
   return;
end
...
try
  ...
  COMBINED_COMPUTED.RUN        = DATA_TMP.RUN;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CANAL SEEPAGE GROUPS: L31N
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L31N seepage:   sz2riv_L31N_mile0to1_C139_Q  : Column 139, Rows 145-148

% pull out and sum timeseries:
try
  TIMESERIES = 0;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R145C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R146C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R147C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R148C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R145C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R146C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R147C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R148C139L2_3dsz2riv')).TIMESERIES;

  % copy metadata into data structure format:
  COMBINED_COMPUTED.NAME       = {'sz2riv_L31N_mile0to1_C139_Q'};
  COMBINED_COMPUTED.TIMESERIES = TIMESERIES;
  COMBINED_COMPUTED.TIMEVECTOR = DATA_TMP.TIMEVECTOR;
  COMBINED_COMPUTED.DFSTYPE    = DATA_TMP.DFSTYPE;
  COMBINED_COMPUTED.UNIT       = DATA_TMP.UNIT;
  ...
  % append new key and data structure to container
  MAP_ALL_DATA('sz2riv_L31N_mile0to1_C139_Q') = COMBINED_COMPUTED;
catch
  fprintf('\nWARNING - problem calculating model group: %s  - skipped', 'sz2riv_L31N_mile0to1_C139_Q');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L31N seepage:   sz2riv_L31N_mile0to1_C140_Q  : Column 140, Rows 145-148

% pull out and sum timeseries:
try
  TIMESERIES = 0;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R145C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R146C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R147C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R148C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R145C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R146C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R147C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R148C140L2_3dsz2riv')).TIMESERIES;

  % copy metadata into data structure format:
  COMBINED_COMPUTED.NAME       = {'sz2riv_L31N_mile0to1_C140_Q'};
  COMBINED_COMPUTED.TIMESERIES = TIMESERIES;
  COMBINED_COMPUTED.TIMEVECTOR = DATA_TMP.TIMEVECTOR;
  COMBINED_COMPUTED.DFSTYPE    = DATA_TMP.DFSTYPE;
  COMBINED_COMPUTED.UNIT       = DATA_TMP.UNIT;
  ...
  % append new key and data structure to container
  MAP_ALL_DATA('sz2riv_L31N_mile0to1_C140_Q') = COMBINED_COMPUTED;
catch
  fprintf('\nWARNING - problem calculating model group: %s  - skipped', 'sz2riv_L31N_mile0to1_C140_Q');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L31N seepage:   sz2riv_L31N_mile1to3_C139_Q  : Column 139, Rows 137-144

% pull out and sum timeseries:
try
  TIMESERIES = 0;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R137C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R138C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R139C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R140C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R141C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R142C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R143C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R144C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R137C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R138C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R139C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R140C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R141C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R142C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R143C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R144C139L2_3dsz2riv')).TIMESERIES;

  % copy metadata into data structure format:
  COMBINED_COMPUTED.NAME       = {'sz2riv_L31N_mile1to3_C139_Q'};
  COMBINED_COMPUTED.TIMESERIES = TIMESERIES;
  COMBINED_COMPUTED.TIMEVECTOR = DATA_TMP.TIMEVECTOR;
  COMBINED_COMPUTED.DFSTYPE    = DATA_TMP.DFSTYPE;
  COMBINED_COMPUTED.UNIT       = DATA_TMP.UNIT;
  ...
  % append new key and data structure to container
  MAP_ALL_DATA('sz2riv_L31N_mile1to3_C139_Q') = COMBINED_COMPUTED;
catch
  fprintf('\nWARNING - problem calculating model group: %s  - skipped', 'sz2riv_L31N_mile1to3_C139_Q');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L31N seepage:   sz2riv_L31N_mile1to3_C140_Q  : Column 140, Rows 137-144

% pull out and sum timeseries:
try
  TIMESERIES = 0;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R137C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R138C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R139C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R140C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R141C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R142C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R143C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R144C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R137C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R138C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R139C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R140C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R141C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R142C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R143C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R144C140L2_3dsz2riv')).TIMESERIES;

  % copy metadata into data structure format:
  COMBINED_COMPUTED.NAME       = {'sz2riv_L31N_mile1to3_C140_Q'};
  COMBINED_COMPUTED.TIMESERIES = TIMESERIES;
  COMBINED_COMPUTED.TIMEVECTOR = DATA_TMP.TIMEVECTOR;
  COMBINED_COMPUTED.DFSTYPE    = DATA_TMP.DFSTYPE;
  COMBINED_COMPUTED.UNIT       = DATA_TMP.UNIT;
  ...
  % append new key and data structure to container
  MAP_ALL_DATA('sz2riv_L31N_mile1to3_C140_Q') = COMBINED_COMPUTED;
catch
  fprintf('\nWARNING - problem calculating model group: %s  - skipped', 'sz2riv_L31N_mile1to3_C140_Q');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L31N seepage:   sz2riv_L31N_mile3to4_C139_Q  : Column 139, Rows 132-136

% pull out and sum timeseries:
try
  TIMESERIES = 0;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R132C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R133C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R134C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R135C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R136C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R132C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R133C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R134C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R135C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R136C139L2_3dsz2riv')).TIMESERIES;

  % copy metadata into data structure format:
  COMBINED_COMPUTED.NAME       = {'sz2riv_L31N_mile3to4_C139_Q'};
  COMBINED_COMPUTED.TIMESERIES = TIMESERIES;
  COMBINED_COMPUTED.TIMEVECTOR = DATA_TMP.TIMEVECTOR;
  COMBINED_COMPUTED.DFSTYPE    = DATA_TMP.DFSTYPE;
  COMBINED_COMPUTED.UNIT       = DATA_TMP.UNIT;
  ...
  % append new key and data structure to container
  MAP_ALL_DATA('sz2riv_L31N_mile3to4_C139_Q') = COMBINED_COMPUTED;
catch
  fprintf('\nWARNING - problem calculating model group: %s  - skipped', 'sz2riv_L31N_mile3to4_C139_Q');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L31N seepage:   sz2riv_L31N_mile3to4_C140_Q  : Column 140, Rows 132-136

% pull out and sum timeseries:
try
  TIMESERIES = 0;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R132C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R133C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R134C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R135C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R136C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R132C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R133C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R134C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R135C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R136C140L2_3dsz2riv')).TIMESERIES;

  % copy metadata into data structure format:
  COMBINED_COMPUTED.NAME       = {'sz2riv_L31N_mile3to4_C140_Q'};
  COMBINED_COMPUTED.TIMESERIES = TIMESERIES;
  COMBINED_COMPUTED.TIMEVECTOR = DATA_TMP.TIMEVECTOR;
  COMBINED_COMPUTED.DFSTYPE    = DATA_TMP.DFSTYPE;
  COMBINED_COMPUTED.UNIT       = DATA_TMP.UNIT;
  ...
  % append new key and data structure to container
  MAP_ALL_DATA('sz2riv_L31N_mile3to4_C140_Q') = COMBINED_COMPUTED;
catch
  fprintf('\nWARNING - problem calculating model group: %s  - skipped', 'sz2riv_L31N_mile3to4_C140_Q');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L31N seepage:   sz2riv_L31N_mile4to5_C139_Q  : Column 139, Rows 128-131

% pull out and sum timeseries:
try
  TIMESERIES = 0;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R128C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R129C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R130C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R131C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R128C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R129C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R130C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R131C139L2_3dsz2riv')).TIMESERIES;

  % copy metadata into data structure format:
  COMBINED_COMPUTED.NAME       = {'sz2riv_L31N_mile4to5_C139_Q'};
  COMBINED_COMPUTED.TIMESERIES = TIMESERIES;
  COMBINED_COMPUTED.TIMEVECTOR = DATA_TMP.TIMEVECTOR;
  COMBINED_COMPUTED.DFSTYPE    = DATA_TMP.DFSTYPE;
  COMBINED_COMPUTED.UNIT       = DATA_TMP.UNIT;
  ...
  % append new key and data structure to container
  MAP_ALL_DATA('sz2riv_L31N_mile4to5_C139_Q') = COMBINED_COMPUTED;
catch
  fprintf('\nWARNING - problem calculating model group: %s  - skipped', 'sz2riv_L31N_mile4to5_C139_Q');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L31N seepage:   sz2riv_L31N_mile4to5_C140_Q  : Column 140, Rows 128-131

% pull out and sum timeseries:
try
  TIMESERIES = 0;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R128C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R129C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R130C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R131C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R128C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R129C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R130C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R131C140L2_3dsz2riv')).TIMESERIES;

  % copy metadata into data structure format:
  COMBINED_COMPUTED.NAME       = {'sz2riv_L31N_mile4to5_C140_Q'};
  COMBINED_COMPUTED.TIMESERIES = TIMESERIES;
  COMBINED_COMPUTED.TIMEVECTOR = DATA_TMP.TIMEVECTOR;
  COMBINED_COMPUTED.DFSTYPE    = DATA_TMP.DFSTYPE;
  COMBINED_COMPUTED.UNIT       = DATA_TMP.UNIT;
  ...
  % append new key and data structure to container
  MAP_ALL_DATA('sz2riv_L31N_mile4to5_C140_Q') = COMBINED_COMPUTED;
catch
  fprintf('\nWARNING - problem calculating model group: %s  - skipped', 'sz2riv_L31N_mile4to5_C140_Q');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L31N seepage:   sz2riv_L31N_mile5to7_C139_Q  : Column 139, Rows 121-127

% pull out and sum timeseries:
try
  TIMESERIES = 0;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R121C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R122C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R123C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R124C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R125C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R126C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R127C139L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R121C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R122C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R123C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R124C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R125C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R126C139L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R127C139L2_3dsz2riv')).TIMESERIES;

  % copy metadata into data structure format:
  COMBINED_COMPUTED.NAME       = {'sz2riv_L31N_mile5to7_C139_Q'};
  COMBINED_COMPUTED.TIMESERIES = TIMESERIES;
  COMBINED_COMPUTED.TIMEVECTOR = DATA_TMP.TIMEVECTOR;
  COMBINED_COMPUTED.DFSTYPE    = DATA_TMP.DFSTYPE;
  COMBINED_COMPUTED.UNIT       = DATA_TMP.UNIT;
  ...
  % append new key and data structure to container
  MAP_ALL_DATA('sz2riv_L31N_mile5to7_C139_Q') = COMBINED_COMPUTED;
catch
  fprintf('\nWARNING - problem calculating model group: %s  - skipped', 'sz2riv_L31N_mile5to7_C139_Q');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L31N seepage:   sz2riv_L31N_mile5to7_C140_Q  : Column 140, Rows 121-127

% pull out and sum timeseries:
try
  TIMESERIES = 0;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R121C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R122C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R123C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R124C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R125C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R126C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R127C140L1_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R121C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R122C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R123C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R124C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R125C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R126C140L2_3dsz2riv')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('R127C140L2_3dsz2riv')).TIMESERIES;

  % copy metadata into data structure format:
  COMBINED_COMPUTED.NAME       = {'sz2riv_L31N_mile5to7_C140_Q'};
  COMBINED_COMPUTED.TIMESERIES = TIMESERIES;
  COMBINED_COMPUTED.TIMEVECTOR = DATA_TMP.TIMEVECTOR;
  COMBINED_COMPUTED.DFSTYPE    = DATA_TMP.DFSTYPE;
  COMBINED_COMPUTED.UNIT       = DATA_TMP.UNIT;
  ...
  % append new key and data structure to container
  MAP_ALL_DATA('sz2riv_L31N_mile5to7_C140_Q') = COMBINED_COMPUTED;
catch
  fprintf('\nWARNING - problem calculating model group: %s  - skipped', 'sz2riv_L31N_mile5to7_C140_Q');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L31N seepage:   sz2riv_L31N_mile0to7_C139_Q : Column 139, Rows 121-148

% pull out and sum timeseries:
try
  TIMESERIES = 0;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('sz2riv_L31N_mile0to1_C139_Q')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('sz2riv_L31N_mile1to3_C139_Q')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('sz2riv_L31N_mile3to4_C139_Q')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('sz2riv_L31N_mile4to5_C139_Q')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('sz2riv_L31N_mile5to7_C139_Q')).TIMESERIES;

  % copy metadata into data structure format:
  COMBINED_COMPUTED.NAME       = {'sz2riv_L31N_mile0to7_C139_Q'};
  COMBINED_COMPUTED.TIMESERIES = TIMESERIES;
  COMBINED_COMPUTED.TIMEVECTOR = DATA_TMP.TIMEVECTOR;
  COMBINED_COMPUTED.DFSTYPE    = DATA_TMP.DFSTYPE;
  COMBINED_COMPUTED.UNIT       = DATA_TMP.UNIT;
  ...
  % append new key and data structure to container
  MAP_ALL_DATA('sz2riv_L31N_mile0to7_C139_Q') = COMBINED_COMPUTED;
catch
  fprintf('\nWARNING - problem calculating model group: %s  - skipped', 'sz2riv_L31N_mile0to7_C139_Q');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L31N seepage:   sz2riv_L31N_mile0to7_C140_Q : Column 140, Rows 121-148

% pull out and sum timeseries:
try
  TIMESERIES = 0;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('sz2riv_L31N_mile0to1_C140_Q')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('sz2riv_L31N_mile1to3_C140_Q')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('sz2riv_L31N_mile3to4_C140_Q')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('sz2riv_L31N_mile4to5_C140_Q')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('sz2riv_L31N_mile5to7_C140_Q')).TIMESERIES;

  % copy metadata into data structure format:
  COMBINED_COMPUTED.NAME       = {'sz2riv_L31N_mile0to7_C140_Q'};
  COMBINED_COMPUTED.TIMESERIES = TIMESERIES;
  COMBINED_COMPUTED.TIMEVECTOR = DATA_TMP.TIMEVECTOR;
  COMBINED_COMPUTED.DFSTYPE    = DATA_TMP.DFSTYPE;
  COMBINED_COMPUTED.UNIT       = DATA_TMP.UNIT;
  ...
  % append new key and data structure to container
  MAP_ALL_DATA('sz2riv_L31N_mile0to7_C140_Q') = COMBINED_COMPUTED;
catch
  fprintf('\nWARNING - problem calculating model group: %s  - skipped', 'sz2riv_L31N_mile0to7_C140_Q');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L31N seepage:   sz2riv_L31N_mile0to7_Q : Column 139-140, Rows 121-148

% pull out and sum timeseries:
try
  TIMESERIES = 0;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('sz2riv_L31N_mile0to7_C139_Q')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('sz2riv_L31N_mile0to7_C140_Q')).TIMESERIES;

  % copy metadata into data structure format:
  COMBINED_COMPUTED.NAME       = {'sz2riv_L31N_mile0to7_Q'};
  COMBINED_COMPUTED.TIMESERIES = TIMESERIES;
  COMBINED_COMPUTED.TIMEVECTOR = DATA_TMP.TIMEVECTOR;
  COMBINED_COMPUTED.DFSTYPE    = DATA_TMP.DFSTYPE;
  COMBINED_COMPUTED.UNIT       = DATA_TMP.UNIT;
  ...
  % append new key and data structure to container
  MAP_ALL_DATA('sz2riv_L31N_mile0to7_Q') = COMBINED_COMPUTED;
catch
  fprintf('\nWARNING - problem calculating model group: %s  - skipped', 'sz2riv_L31N_mile0to7_Q');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L31N seepage:   sz2riv_L31N_mile1to7_C139_Q : Column 139, Rows 121-144
...
try
  ...
  % copy metadata into data structure format:
  COMBINED_COMPUTED.NAME       = {'sz2riv_L31N_mile1to7_C139_Q'};
  COMBINED_COMPUTED.TIMESERIES = TIMESERIES;
  COMBINED_COMPUTED.TIMEVECTOR = DATA_TMP.TIMEVECTOR;
  COMBINED_COMPUTED.DFSTYPE    = DATA_TMP.DFSTYPE;
  COMBINED_COMPUTED.UNIT       = DATA_TMP.UNIT;
  ...
  % append new key and data structure to container
  MAP_ALL_DATA('sz2riv_L31N_mile1to7_C139_Q') = COMBINED_COMPUTED;
catch
  fprintf('\nWARNING - problem calculating model group: %s  - skipped', 'sz2riv_L31N_mile1to7_C139_Q');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L31N seepage:   sz2riv_L31N_mile1to7_C140_Q : Column 140, Rows 121-144
...
try
  ...
  % copy metadata into data structure format:
  COMBINED_COMPUTED.NAME       = {'sz2riv_L31N_mile1to7_C140_Q'};
  COMBINED_COMPUTED.TIMESERIES = TIMESERIES;
  COMBINED_COMPUTED.TIMEVECTOR = DATA_TMP.TIMEVECTOR;
  COMBINED_COMPUTED.DFSTYPE    = DATA_TMP.DFSTYPE;
  COMBINED_COMPUTED.UNIT       = DATA_TMP.UNIT;
  ...
  % append new key and data structure to container
  MAP_ALL_DATA('sz2riv_L31N_mile1to7_C140_Q') = COMBINED_COMPUTED;
catch
  fprintf('\nWARNING - problem calculating model group: %s  - skipped', 'sz2riv_L31N_mile1to7_C140_Q');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L31N seepage:   sz2riv_L31N_mile1to7_Q : Column 139-140, Rows 121-144

% pull out and sum timeseries:
try
  TIMESERIES = 0;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('sz2riv_L31N_mile1to7_C139_Q')).TIMESERIES;
  TIMESERIES = TIMESERIES + MAP_ALL_DATA(char('sz2riv_L31N_mile1to7_C140_Q')).TIMESERIES;

  % copy metadata into data structure format:
  COMBINED_COMPUTED.NAME       = {'sz2riv_L31N_mile1to7_Q'};
  COMBINED_COMPUTED.TIMESERIES = TIMESERIES;
  COMBINED_COMPUTED.TIMEVECTOR = DATA_TMP.TIMEVECTOR;
  COMBINED_COMPUTED.DFSTYPE    = DATA_TMP.DFSTYPE;
  COMBINED_COMPUTED.UNIT       = DATA_TMP.UNIT;
  ...
  % append new key and data structure to container
  MAP_ALL_DATA('sz2riv_L31N_mile1to7_Q') = COMBINED_COMPUTED;
catch
  fprintf('\nWARNING - problem calculating model group: %s  - skipped', 'sz2riv_L31N_mile1to7_Q');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L31N seepage:   sz2riv_L31N_mile1to3_Q : Column 139-140, Rows 137-144
...
try
  ...
  % copy metadata into data structure format:
  COMBINED_COMPUTED.NAME       = {'sz2riv_L31N_mile1to3_Q'};
  COMBINED_COMPUTED.TIMESERIES = TIMESERIES;
  COMBINED_COMPUTED.TIMEVECTOR = DATA_TMP.TIMEVECTOR;
  COMBINED_COMPUTED.DFSTYPE    = DATA_TMP.DFSTYPE;
  COMBINED_COMPUTED.UNIT       = DATA_TMP.UNIT;
  ...
  % append new key and data structure to container
  MAP_ALL_DATA('sz2riv_L31N_mile1to3_Q') = COMBINED_COMPUTED;
catch
  fprintf('\nWARNING - problem calculating model group: %s  - skipped', 'sz2riv_L31N_mile1to3_Q');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L31N seepage:   sz2riv_L31N_mile3to4_Q : Column 139-140, Rows 132-136
...
try
  ...
  % copy metadata into data structure format:
  COMBINED_COMPUTED.NAME       = {'sz2riv_L31N_mile3to4_Q'};
  COMBINED_COMPUTED.TIMESERIES = TIMESERIES;
  COMBINED_COMPUTED.TIMEVECTOR = DATA_TMP.TIMEVECTOR;
  COMBINED_COMPUTED.DFSTYPE    = DATA_TMP.DFSTYPE;
  COMBINED_COMPUTED.UNIT       = DATA_TMP.UNIT;
  ...
  % append new key and data structure to container
  MAP_ALL_DATA('sz2riv_L31N_mile3to4_Q') = COMBINED_COMPUTED;
catch
  fprintf('\nWARNING - problem calculating model group: %s  - skipped', 'sz2riv_L31N_mile3to4_Q');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L31N seepage:   sz2riv_L31N_mile4to5_Q : Column 139-140, Rows 128-131
...
try
  ...
  % copy metadata into data structure format:
  COMBINED_COMPUTED.NAME       = {'sz2riv_L31N_mile4to5_Q'};
  COMBINED_COMPUTED.TIMESERIES = TIMESERIES;
  COMBINED_COMPUTED.TIMEVECTOR = DATA_TMP.TIMEVECTOR;
  COMBINED_COMPUTED.DFSTYPE    = DATA_TMP.DFSTYPE;
  COMBINED_COMPUTED.UNIT       = DATA_TMP.UNIT;
  ...
  % append new key and data structure to container
  MAP_ALL_DATA('sz2riv_L31N_mile4to5_Q') = COMBINED_COMPUTED;
catch
  fprintf('\nWARNING - problem calculating model group: %s  - skipped', 'sz2riv_L31N_mile4to5_Q');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L31N seepage:   sz2riv_L31N_mile5to7_Q : Column 139-140, Rows 121-127
...
try
  ...
  % copy metadata into data structure format:
  COMBINED_COMPUTED.NAME       = {'sz2riv_L31N_mile5to7_Q'};
  COMBINED_COMPUTED.TIMESERIES = TIMESERIES;
  COMBINED_COMPUTED.TIMEVECTOR = DATA_TMP.TIMEVECTOR;
  COMBINED_COMPUTED.DFSTYPE    = DATA_TMP.DFSTYPE;
  COMBINED_COMPUTED.UNIT       = DATA_TMP.UNIT;
  ...
  % append new key and data structure to container
  MAP_ALL_DATA('sz2riv_L31N_mile5to7_Q') = COMBINED_COMPUTED;
catch
  fprintf('\nWARNING - problem calculating model group: %s  - skipped', 'sz2riv_L31N_mile5to7_Q');
end
