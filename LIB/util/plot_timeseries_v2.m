function [output_args] = plot_timeseries_v2(STATION,SIM,F,PLOT_FIGURES)
%---------------------------------------------
...
if PLOT_FIGURES
    ...
    %rjf; changed annotation
    zsg = num2str(STATION.Z_GRID,3);
    %zss = num2str(STATION.Z_SURVEY,3);
    %zsd = num2str(STATION.Z_SURVEY-STATION.Z_GRID,2);
    string_ground_level = ['GSE: grid = ' zsg ' ft'];
    add_ground_levelV0(0,0.9,STATION.Z_GRID,[1 0 0],3,'--',12,string_ground_level);
    %string_ground_level = ['     survey = ', zss, ' ft'];
    %add_ground_levelV0(0,0.9,STATION.Z_SURVEY,[0 0.5 0],2,'-',12,string_ground_level);
