function [MAP_DATA_ALL] = add_observedV2(INI,MAP_COMPUTED,DATA)
...
%     DATA_ALL(ii).Z_SURVEY = {-1.0e-35};
    ...
    try
        ...
        TIMESERIES_OBS = extract_period_tsV0(TIMESERIES_TMP, TIMEVECTOR_OBS,INI.ANALYZE_DATE_I,INI.ANALYZE_DATE_F);
