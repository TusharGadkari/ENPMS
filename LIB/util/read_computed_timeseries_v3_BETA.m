function [MAP_COMPUTED_DFS] = read_computed_timeseries_v3_BETA(FILE_DFS,CELL_DEF_FILE_DIR,CELL_DEF_FILE_NAME,CELL_DEF_FILE_SHEETNAME);
...
%      MyDfsFileDim = 11; % not really 11-dinensional, just a code used in if stmt below ;)
   else
...
elseif MyDfsFileDim == 2 || MyDfsFileDim == 3
   ...
   [MyRequestedStnNames,MyRequestedStns] = get_cells_from_xls_v1_BETA(...
   ...
   [TimeseriesData] = get_dfs23_timeseries_v1_BETA(MyDfsFile,MyRequestedStns,1,NumDfsSteps);
   
% elseif MyDfsFileDim == 11
